...
<div align="left"><a href="./profile/README_EN.md">English</a> | Español</div>

<p align="center"><strong>Orden desde el caos para la era de los agentes de IA.</strong></p>

Este es el repositorio `.github` de **SyntropyOS**: perfil público de la organización y documentos de comunidad (los mismos que rigen todos los repos de la org).
...
| Licencia | [LICENSE](./LICENSE) · [NOTICE](./NOTICE) | — |

## Contacto

- 📧 [syntropyos.ia@gmail.com](mailto:syntropyos.ia@gmail.com)
