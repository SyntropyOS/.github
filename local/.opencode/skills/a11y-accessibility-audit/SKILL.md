...
The full doctrine — WCAG-EM in detail, the severity rubric with examples, the no-proxy boundary, grounding — is in [`../a11y-shared/methodology.md`](../a11y-shared/methodology.md). The rules needed to run this skill are below.
